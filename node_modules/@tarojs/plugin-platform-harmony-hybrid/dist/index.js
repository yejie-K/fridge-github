...
class H5 extends service.TaroPlatformWeb {
    ...
    modifyWebpackConfig() {
        this.ctx.modifyWebpackChain(({ chain }) => {
            ...
            apis = new Set(Array.from(apis).filter((x) => !routerApis.has(x)));
            ...
            chain.plugin('htmlWebpackPlugin').tap((args) => {
                var _a, _b, _c, _d, _e;
                const options = ((_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.postcss) === null || _b === void 0 ? void 0 : _b.pxtransform) === null || _c === void 0 ? void 0 : _c.config) || {};
                // const max = options?.maxRootSize ?? 40
                // const min = options?.minRootSize ?? 20
                const baseFontSize = (options === null || options === void 0 ? void 0 : options.baseFontSize) || 20; // (min > 1 ? min : 20)
                ...
                let htmlScript = '';
                if (((_e = (_d = this.config) === null || _d === void 0 ? void 0 : _d.targetUnit) !== null && _e !== void 0 ? _e : 'rem') === 'rem') {
                    /**
                     * 缩放策略为：
                     * 1. 手机-竖屏，缩放策略为“自动缩放”
