...
class ProxyHandler {
    constructor(native) {
        ...
        native.onStorageStatusChange((type, key) => {
        ...
        if (propKey === 'getStorageSync') {
            return (...args) => {
                ...
                if (this.cacheMap.has(key)) {
                    ...
                    if (res) {
                        // @ts-ignore
                        this.cacheMap.set(key, res === null || res === void 0 ? void 0 : res.data);
                    }
                    return res;
                }
            };
...
function storageCacheAndSyncProxy(native) {
    return new Proxy(native, new ProxyHandler(native));
}

export { storageCacheAndSyncProxy };
//# sourceMappingURL=StorageCacheAndSyncProxy.js.map
