 ...
 */
const offLocationChange = (callback) => {
    ...
    nativeLocation.offLocationChange((res) => {
        const cbResult = {
            /** 位置的精确度 */
...
export { offLocationChange };
//# sourceMappingURL=offLocationChange.js.map
