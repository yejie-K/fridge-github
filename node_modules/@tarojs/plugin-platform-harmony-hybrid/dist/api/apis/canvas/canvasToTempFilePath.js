import { shouldBeObject, findDOM } from '../utils/index.js';
 ...
 */
const canvasToTempFilePath = (options, inst) => {
    ...
    const { canvas, canvasId, quality = QUALITY, destHeight = 0, destWidth = 0, fileType = 'png', height = 0, width = 0, x = 0, y = 0, success, fail, complete, } = options;
    ...
    return new Promise((resolve, reject) => {
        if (canvas) {
            ...
            inCanvas = el === null || el === void 0 ? void 0 : el.querySelector(`canvas[canvas-id="${canvasId}"]`);
            if (!inCanvas) {
