import { __awaiter } from '../../../node_modules/.pnpm/@rollup_plugin-typescript@11.1.6_rollup@3.29.5_tslib@2.8.1_typescript@5.4.5/node_modules/tslib/tslib.es6.js';
import native from '../NativeApi.js';
import { shouldBeObject } from '../utils/index.js';
import { MethodHandler } from '../utils/handler.js';
import { getAppAuthorizeSetting } from './getAppAuthorizeSetting/index.js';
import { getSystemSetting } from './getSystemSetting/index.js';
 ...
 */
const openAppAuthorizeSetting = (options) => {
...
const getWindowInfo = () => {
    ...
    const windowInfo = {
        ...
        windowHeight: 
        // @ts-ignore
        info.screenHeight - (((_a = window === null || window === void 0 ? void 0 : window.currentNavigation) === null || _a === void 0 ? void 0 : _a.style) === 'default' ? window.navigationHeight || 0 : 0),
...
const getSystemInfoSync = () => {
    ...
    const systemInfoSync = {
        ...
        fontSizeSetting: (_a = info === null || info === void 0 ? void 0 : info.fontSizeSetting) !== null && _a !== void 0 ? _a : 16,
        /** 客户端基础库版本 */
...
export { getAppBaseInfo, getDeviceInfo, getSystemInfo, getSystemInfoAsync, getSystemInfoSync, getWindowInfo, openAppAuthorizeSetting };
