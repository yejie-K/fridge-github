...
import { setHeader, XHR_STATS, NETWORK_TIMEOUT } from './utils.js';
...
const createDownloadTask = ({ url, header, filePath, withCredentials = true, timeout, success, error, }) => {
    let timeoutInter;
    let totalData = 0;
 ...
 */
const downloadFile = ({ url, header, filePath, withCredentials, timeout, success, fail, complete, }) => {
    let task;
