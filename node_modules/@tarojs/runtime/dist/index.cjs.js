...
class TaroHistory extends shared.Events {
    constructor(location, options) {
        ...
        this.on(exports.CONTEXT_ACTIONS.DESTROY, (pageId) => {
...
class TaroWindow extends shared.Events {
    ...
    initEvent() {
        ...
        this.on(exports.CONTEXT_ACTIONS.DESTROY, (pageId) => {
            ...
            _location.trigger(exports.CONTEXT_ACTIONS.DESTROY, pageId);
            _history.trigger(exports.CONTEXT_ACTIONS.DESTROY, pageId);
        }, null);
    }
    get document() {
        return env.document;
...
function createPageConfig(component, pageName, data, pageConfig) {
    ...
    const config = {
        ...
        [ONUNLOAD]() {
            ...
            // 销毁当前页面的上下文信息
            if (process.env.TARO_PLATFORM !== 'web') {
                taroWindowProvider.trigger(exports.CONTEXT_ACTIONS.DESTROY, $taroPath);
            }
            // 触发onUnload生命周期
