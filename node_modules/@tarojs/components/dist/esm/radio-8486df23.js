import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-89ae5aeb.js';
...
const Radio = class {
  ...
  render() {
    ...
    return (h(Host, { class: 'weui-cells_checkbox', onClick: this.handleClick }, h("input", Object.assign({ ref: dom => {
        if (!dom)
          return;
        this.inputEl = dom;
        if (this.id)
