...
var SwiperJS = require('swiper/bundle');
...
var SwiperJS__default = /*#__PURE__*/_interopDefaultLegacy(SwiperJS);
var resolvePathname__default = /*#__PURE__*/_interopDefaultLegacy(resolvePathname);

const NAMESPACE = 'taro-components';
const BUILD = /* taro-components */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: true, cmpDidUnload: false, cmpDidUpdate: true, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: true, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: true, dynamicImportShim: false, element: false, event: true, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: false, hostListenerTargetDocument: true, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: true, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: false, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: true };
...
class AnimationVideo {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-animation-video-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class AnimationView {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-animation-view-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const indexCss$n = "audio{outline:none;max-width:100%}";
...
class Audio {
  ...
  render() {
    ...
    return (hAsync("audio", Object.assign({ src: src, controls: controls, autoplay: autoplay, loop: loop, muted: muted, ref: audio => { this.audio = audio; } }, nativeProps)));
  }
  static get style() { return indexCss$n; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-audio-core",
    "$members$": {
      "src": [1],
      "controls": [4],
      "autoplay": [4],
...
class Button {
  ...
  render() {
    ...
    return (hAsync(Host, { class: cls, type: type, plain: plain, loading: loading, size: size, disabled: disabled }, loading && hAsync("i", { class: 'weui-loading' }), hAsync("slot", null)));
  }
  get el() { return getElement(this); }
  static get style() { return indexCss$m; }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-button-core",
    "$members$": {
      "disabled": [4],
    ...
    "$listeners$": [[0, "click", "onClick"], [1, "touchstart", "onTouchStart"], [1, "touchend", "onTouchEnd"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": [["formType", "form-type"]]
  }; }
}
...
const indexCss$l = "taro-canvas-core{width:300px;height:150px;display:block;position:relative}";
...
class Canvas {
  ...
  render() {
    ...
    return (hAsync("canvas", Object.assign({ "canvas-id": canvasId, style: {
        width: '100%',
        height: '100%'
  ...
  get el() { return getElement(this); }
  static get style() { return indexCss$l; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-canvas-core",
    "$members$": {
      "canvasId": [1, "id"],
      "height": [1537],
      "width": [1537],
    ...
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": [["height", "height"], ["width", "width"]]
  }; }
}
...
class ChannelLive {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-channel-live-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class ChannelVideo {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-channel-video-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Checkbox {
  ...
  render() {
    ...
    return (hAsync(Host, { class: 'weui-cells_checkbox' }, hAsync("input", Object.assign({ ref: dom => {
        if (!dom)
          return;
        this.inputEl = dom;
        if (this.id)
          dom.setAttribute('id', this.id);
      }, type: 'checkbox', value: value, name: name, class: 'taro-checkbox_checked', style: { color }, checked: checked, disabled: disabled, onChange: this.handleChange }, nativeProps)), hAsync("slot", null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "id": ["watchId"]
  }; }
  static get style() { return indexCss$k; }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-checkbox-core",
    "$members$": {
      "name": [1],
      "value": [1032],
      "color": [1],
...
class CheckboxGroup {
  ...
  function(e) {
    ...
    __classPrivateFieldSet$3(this, _CheckboxGroup_value, this.getValues(childList), "f");
    this.onChange.emit({
      value: __classPrivateFieldGet$3(this, _CheckboxGroup_value, "f")
    });
  }
  componentDidLoad() {
    const childList = this.el.querySelectorAll('taro-checkbox-core');
    ...
    Object.defineProperty(this.el, 'value', {
      get: () => {
        if (!__classPrivateFieldGet$3(this, _CheckboxGroup_value, "f")) {
          const childList = this.el.querySelectorAll('taro-checkbox-core');
          __classPrivateFieldSet$3(this, _CheckboxGroup_value, this.getValues(childList), "f");
        }
        return __classPrivateFieldGet$3(this, _CheckboxGroup_value, "f");
      },
      configurable: true
    });
  }
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-checkbox-group-core",
    "$members$": {
      "name": [8]
    },
    "$listeners$": [[0, "checkboxchange", "function"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}
...
class CommentDetail {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-comment-detail-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class CommentList {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-comment-list-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class ContactButton {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-contact-button-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const indexCss$j = "taro-cover-image-core{width:320px;height:240px;overflow:hidden}";
...
class CoverImage {
  ...
  render() {
    ...
    return (hAsync("img", Object.assign({ ref: img => (this.imgRef = img), src: src, onLoad: imageOnLoad.bind(this), onError: imageOnError.bind(this) }, nativeProps)));
  }
  static get style() { return indexCss$j; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-cover-image-core",
    "$members$": {
      "src": [1],
      "nativeProps": [16]
    },
...
class CoverView {
  ...
  render() {
    ...
    return (hAsync(Host, Object.assign({ class: cls }, attr), hAsync("slot", null)));
  }
  static get style() { return coverViewCss; }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-cover-view-core",
    "$members$": {
      "animation": [1],
      "hoverClass": [1, "hover-class"],
      "hoverStartTime": [2, "hover-start-time"],
    ...
    "$listeners$": [[1, "touchstart", "onTouchStart"], [1, "touchmove", "onTouchMove"], [1, "touchend", "onTouchEnd"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}
...
class CustomWrapper {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-custom-wrapper-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Form {
  ...
  onButtonSubmit(e) {
    e.stopPropagation();
    __classPrivateFieldSet$2(this, _Form_value, this.getFormValue(), "f");
    this.onSubmit.emit({
      value: __classPrivateFieldGet$2(this, _Form_value, "f")
    });
  }
  onButtonReset(e) {
    e.stopPropagation();
  ...
  componentDidLoad() {
    __classPrivateFieldSet$2(this, _Form_value, this.getFormValue(), "f");
    Object.defineProperty(this.el, 'value', {
      get: () => __classPrivateFieldGet$2(this, _Form_value, "f"),
      configurable: true
    });
  }
  componentDidRender() {
  ...
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-form-core",
    "$members$": undefined,
    "$listeners$": [[0, "tarobuttonsubmit", "onButtonSubmit"], [0, "tarobuttonreset", "onButtonReset"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}
...
class FunctionalPageNavigator {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-functional-page-navigator-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Icon {
  ...
  render() {
    ...
    return (hAsync(Host, { class: cls, style: style }));
  }
  static get style() { return indexCss$i; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-icon-core",
    "$members$": {
      "type": [1],
      "size": [8],
      "color": [1]
...
class InlinePaymentPanel {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-inline-payment-panel-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Input {
  ...
  watchValue(newValue) {
    const value = fixControlledValue$1(newValue);
  ...
  render() {
    ...
    return (hAsync("input", Object.assign({ ref: input => {
        this.inputRef = input;
        if (autoFocus && input)
          input.focus();
      }, class: 'weui-input', type: getTrueType(type, confirmType, password), placeholder: placeholder, autoFocus: autoFocus, disabled: disabled, maxlength: maxlength, name: name, readonly: readonly ? 'readonly' : undefined, onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange, onKeyDown: this.handleKeyDown, onPaste: this.handlePaste, onCompositionStart: this.handleComposition, onCompositionEnd: this.handleComposition }, nativeProps, { value: fixControlledValue$1(value) })));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
class KeyboardAccessory {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-keyboard-accessory-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Label {
  ...
  render() {
    return (hAsync("label", { htmlFor: this.for }, hAsync("slot", null)));
  }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-label-core",
    "$members$": {
      "for": [1]
    },
    "$listeners$": undefined,
...
class Map$1 {
  ...
  render() {
    return (hAsync(Host, null, hAsync("div", { id: "mapContainer", ref: (dom) => {
        if (dom) {
          this.mapRef = dom;
        }
  ...
  static get cmpMeta() { return {
    ...
    "$members$": {
      ...
      "polygons": [16],
      "subkey": [1],
      "layerStyle": [2, "layer-style"],
      "rotate": [2],
      "skew": [2],
      "showCompass": [4, "show-compass"],
      "showScale": [4, "show-scale"],
      "enableOverlooking": [4, "enable-overlooking"],
      "enableZoom": [4, "enable-zoom"],
      "enableScroll": [4, "enable-scroll"],
      "enableRotate": [4, "enable-rotate"],
      "enableSatellite": [4, "enable-satellite"],
      "enableTraffic": [4, "enable-traffic"],
      "enableBuilding": [4, "enable-building"],
      "enableAutoMaxOverlooking": [4, "enable-auto-max-overlooking"],
...
class MovableArea {
  ...
  render() {
    return (hAsync(Host, { onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd }));
  }
  get element() { return getElement(this); }
  static get style() { return areaCss; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-movable-area-core",
    "$members$": {
...
class MovableView {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-movable-view-core",
    "$members$": {
      "x": [8],
      "y": [8],
      "direction": [1],
...
class NavigationBar {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-navigation-bar-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const indexCss$f = ".navigator-hover{background:#efefef}";
...
class Navigator {
  ...
  render() {
    ...
    return (hAsync(Host, { class: classnames({
        [hoverClass]: isHover
      }) }));
  }
...
class OfficialAccount {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-official-account-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class PageContainer {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-page-container-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Picker {
  constructor(hostRef) {
    ...
    // 单列选择器
    this.getSelector = () => {
      return (hAsync("taro-picker-group", { range: this.range, rangeKey: this.rangeKey, height: this.height[0], updateHeight: this.updateHeight, columnId: '0' }));
    };
    // 多列选择器
    this.getMultiSelector = () => {
      return this.range.map((range, index) => {
        return (hAsync("taro-picker-group", { range: range, rangeKey: this.rangeKey, height: this.height[index], updateHeight: this.updateHeight, onColumnChange: this.handleColumnChange, columnId: String(index) }));
      });
    };
    // 时间选择器
    this.getTimeSelector = () => {
      ...
      return [
        hAsync("taro-picker-group", { mode: 'time', range: hourRange, height: this.height[0], updateHeight: this.updateHeight, columnId: '0' }),
        hAsync("taro-picker-group", { mode: 'time', range: minRange, height: this.height[1], updateHeight: this.updateHeight, columnId: '1' })
      ];
    };
    // 日期选择器
    this.getDateSelector = () => {
      ...
      const renderView = [
        hAsync("taro-picker-group", { mode: 'date', range: yearRange, height: height[0], updateDay: this.updateDay, updateHeight: this.updateHeight, columnId: '0' })
      ];
      if (fields === 'month' || fields === 'day') {
        renderView.push(hAsync("taro-picker-group", { mode: 'date', range: monthRange, height: height[1], updateDay: this.updateDay, updateHeight: this.updateHeight, columnId: '1' }));
      }
      if (fields === 'day') {
        renderView.push(hAsync("taro-picker-group", { mode: 'date', range: dayRange, height: height[2], updateDay: this.updateDay, updateHeight: this.updateHeight, columnId: '2' }));
      }
      return renderView;
    };
    this.mode = 'selector';
  ...
  render() {
    ...
    return (hAsync(Host, null, hAsync("div", { onClick: this.showPicker }, hAsync("slot", null), hAsync("input", { type: 'hidden', name: name, value: formatValue(this.pickerValue) })), hAsync("div", { class: 'weui-picker__overlay', style: shouldDivHidden, ref: el => { this.overlay = el; } }, hAsync("div", { class: clsMask, onClick: this.handleCancel }), hAsync("div", { class: clsSlider }, hAsync("div", { class: 'weui-picker__hd' }, hAsync("div", { class: 'weui-picker__action', onClick: this.handleCancel }, (_a = this.textProps.cancelText) !== null && _a !== void 0 ? _a : '取消'), hAsync("div", { class: 'weui-picker__action', onClick: this.handleChange }, (_b = this.textProps.okText) !== null && _b !== void 0 ? _b : '确定')), hAsync("div", { class: 'weui-picker__bd' }, pickerGroup), hAsync("input", { type: 'hidden', name: name, value: formatValue(this.pickerValue) })))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "mode": ["onPropsChange"],
...
const indexCss$d = ".taro-picker-view-container{display:flex;position:relative}.taro-picker-view-mask-container{pointer-events:none;flex-direction:column;display:flex;position:absolute;inset:0}.taro-picker-view-mask-indicator{border-top:1px solid #ddd;border-bottom:1px solid #ddd;height:50px;display:flex}.taro-picker-view-mask-top{background-image:linear-gradient(rgba(255,255,255,.95),rgba(255,255,255,.6));flex:1}.taro-picker-view-mask-bottom{background:linear-gradient(rgba(255,255,255,.6),rgba(255,255,255,.95));flex:1}";
...
class PickerView {
  ...
  render() {
    ...
    return (hAsync(Host, { class: "taro-picker-view-container" }, hAsync("slot", null), hAsync("div", { class: "taro-picker-view-mask-container" }, hAsync("div", { class: maskTopCls, style: maskTopStyle }), hAsync("div", { class: indicatorCls, style: indicatorStyle, ref: indicator => (this.indicator = indicator) }), hAsync("div", { class: maskBtmCls, style: maskBottomStyle }))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "value": ["onPropsChange"]
  ...
  static get cmpMeta() { return {
    ...
    "$listeners$": [[0, "onselect", "onSelect"], [0, "onselectstart", "onSelectStart"], [0, "onselectend", "onPickerColEnd"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}
...
class PickerViewColumn {
  ...
  render() {
    ...
    return (hAsync(Host, { class: "taro-picker-view-column-container", style: { 'padding-top': `${paddingVertical}px`, 'padding-bottom': `${paddingVertical}px` } }));
  }
  get el() { return getElement(this); }
  static get style() { return columnCss; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-picker-view-column-core",
    "$members$": {
      "col": [1],
    ...
    "$listeners$": [[1, "touchstart", "onTouchStart"], [1, "touchend", "onTouchEnd"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}

const indexCss$c = ".weui-progress{align-items:center;display:flex}.weui-progress__bar{background-color:#ebebeb;flex:1;height:3px}.weui-progress__inner-bar{background-color:#09bb07;width:0;height:100%}.weui-progress__opr{margin-left:15px;font-size:0;display:block}";
...
class Progress {
  ...
  render() {
    ...
    return (hAsync(Host, { class: 'weui-progress' }, hAsync("div", { class: 'weui-progress__bar', style: pgHeight }, hAsync("div", { class: 'weui-progress__inner-bar', style: pgWidth })), showInfo && (hAsync("div", { class: 'weui-progress__opr', style: { 'font-size': `${fontSize}px` } }, hAsync("span", null, pgPercent, "%")))));
  }
  static get style() { return indexCss$c; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-progress-core",
    "$members$": {
      "percent": [2],
...
class PullToRefresh {
  ...
  render() {
    const renderRefresh = (cls) => {
      ...
      return (hAsync("div", { class: `${prefixCls}-content-wrapper` }, hAsync("div", { class: cla, ref: el => {
          this.contentRef = el;
        } }, showIndicator && (hAsync("div", { class: `${prefixCls}-indicator` }, hAsync("div", null), hAsync("div", null), hAsync("div", null))), hAsync("slot", null))));
    };
    if (this.scrollContainer) {
      return renderRefresh(`${this.prefixCls}-content ${this.prefixCls}-down`);
    }
    return (hAsync(Host, { class: classnames(this.prefixCls, `${this.prefixCls}-down`) }, renderRefresh(`${this.prefixCls}-content`)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "currSt": ["statusChange"]
  ...
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-pull-to-refresh-core",
    "$members$": {
...
class Radio {
  ...
  render() {
    ...
    return (hAsync(Host, { class: 'weui-cells_checkbox', onClick: this.handleClick }, hAsync("input", Object.assign({ ref: dom => {
        if (!dom)
          return;
        this.inputEl = dom;
        if (this.id)
          dom.setAttribute('id', this.id);
      }, type: 'radio', name: name, value: value, class: 'weui-check', checked: checked, disabled: disabled, onChange: e => e.stopPropagation() }, nativeProps)), hAsync("i", { class: 'weui-icon-checked' }), hAsync("slot", null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
class RadioGroup {
  ...
  function(e) {
    ...
    if (target.checked) {
      ...
      __classPrivateFieldSet$1(this, _RadioGroup_value, e.detail.value, "f");
      this.onChange.emit({
        value: __classPrivateFieldGet$1(this, _RadioGroup_value, "f")
      });
    }
  }
  componentDidLoad() {
    ...
    Object.defineProperty(this.el, 'value', {
      get: () => {
        if (!__classPrivateFieldGet$1(this, _RadioGroup_value, "f")) {
          const childList = this.el.querySelectorAll('taro-radio-core');
          __classPrivateFieldSet$1(this, _RadioGroup_value, this.getValues(childList), "f");
        }
        return __classPrivateFieldGet$1(this, _RadioGroup_value, "f");
      },
      configurable: true
    });
  }
  ...
  render() {
    return (hAsync(Host, { class: 'weui-cells_radiogroup' }));
  }
  get el() { return getElement(this); }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-radio-group-core",
    "$members$": {
      "name": [8]
    },
    "$listeners$": [[0, "radiochange", "function"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}
...
const indexCss$a = "taro-rich-text-core{user-select:none}taro-rich-text-core[selectable=true],taro-rich-text-core[user-select=true]{user-select:text;display:block}taro-rich-text-core[space]{white-space:pre-wrap}taro-rich-text-core[space=ensp]{word-spacing:.5em}taro-rich-text-core[space=nbsp]{word-spacing:1em}";
...
class RichText {
  constructor(hostRef) {
    ...
    this.renderNode = (node) => {
      if ('type' in node && node.type === 'text') {
        ...
        // @ts-ignore
        return hAsync(name, attributes, childList);
      }
      return null;
    };
  ...
  render() {
    ...
    if (Array.isArray(nodes)) {
      return (hAsync(Host, null, nodes.map(node => renderNode(node))));
    }
    else {
      return hAsync(Host, { innerHTML: nodes });
    }
  }
  static get style() { return indexCss$a; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-rich-text-core",
    "$members$": {
      "nodes": [1],
      "selectable": [1028],
...
class RtcRoomItem {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-rtc-room-item-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const indexCss$9 = "taro-scroll-view-core{-webkit-overflow-scrolling:touch;width:100%;display:block}.taro-scroll-view__scroll-x{overflow:scroll hidden}.taro-scroll-view__scroll-y{overflow:hidden scroll}.taro-scroll--hidebar::-webkit-scrollbar{display:none}";
...
class ScrollView {
  ...
  render() {
    ...
    return (hAsync(Host, { class: cls }, hAsync("slot", null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
  ...
  static get cmpMeta() { return {
    ...
    "$members$": {
      ...
      "enhanced": [4],
      "showScrollbar": [4, "show-scrollbar"],
      "mpScrollToMethod": [64],
      "mpScrollIntoViewMethod": [64]
    },
    "$listeners$": [[1, "scroll", "handleScroll"], [1, "touchmove", "handleTouchMove"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": [["mpScrollTop", "scroll-top"], ["mpScrollLeft", "scroll-left"], ["mpScrollIntoView", "scroll-into-view"]]
  }; }
}
...
class ShareElement {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-share-element-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const indexCss$8 = ".weui-slider{user-select:none;padding:15px 18px}.weui-slider__inner{background-color:#e9e9e9;height:2px;position:relative}.weui-slider__track{background-color:#1aad19;width:0;height:2px}.weui-slider__handler{background-color:#fff;border-radius:50%;width:28px;height:28px;margin-top:-14px;margin-left:-14px;position:absolute;top:50%;left:0;box-shadow:0 0 4px rgba(0,0,0,.2)}.weui-slider-box{align-items:center;display:flex}.weui-slider-box .weui-slider{flex:1}.weui-slider-box__value{color:#888;text-align:center;min-width:24px;margin-left:.5em;font-size:14px}";
...
class Slider {
  ...
  render() {
    ...
    return (hAsync(Host, { class: 'weui-slider-box' }, hAsync("div", { class: 'weui-slider' }, hAsync("div", { class: 'weui-slider__inner', style: innerStyles, ref: c => (this.sliderInsRef = c) }, hAsync("div", { style: trackStyles, class: 'weui-slider__track' }), hAsync("div", { class: 'weui-slider__handler', ref: dom => {
        if (dom)
          this.handler = dom;
      }, style: handlerStyles }), hAsync("input", { type: 'hidden', name: name, value: value }))), showValue && hAsync("div", { class: 'weui-slider-box__value' }, value)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "value": ["function"]
...
class StickyHeader {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-sticky-header-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class StickySection {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-sticky-section-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
class Swiper {
  ...
  render() {
    ...
    return (hAsync(Host, { class: `taro-swiper-${__classPrivateFieldGet(this, _Swiper_id, "f")}`, style: hostStyle }, hAsync("div", { class: 'swiper-container' }, hAsync("style", { type: 'text/css' }, `
            ...
            `), hAsync("div", { class: 'swiper-wrapper' }, hAsync("slot", null)), hAsync("div", { class: 'swiper-pagination' }))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
...
class SwiperItem {
  ...
  render() {
    return (hAsync(Host, { "item-id": this.itemId }, hAsync("slot", null)));
  }
  get el() { return getElement(this); }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "taro-swiper-item-core",
    "$members$": {
      "itemId": [1, "item-id"]
    },
    "$listeners$": undefined,
...
class Tabbar {
  ...
  render() {
    ...
    return (hAsync(Host, { class: classnames(basicTabBarClassName, `${basicTabBarClassName}-${tabbarPos}`, {
        [hideTabBarClassName]: shouldHideTabBar,
        [hideTabBarWithAnimationClassName]: shouldSlideout
      }) }, hAsync("div", { class: containerCls, style: {
      ...
      return (hAsync(TabbarItem, { index: index, onSelect: this.switchTab.bind(this), isSelected: isSelected, textColor: textColor, iconPath: iconPath, pagePath: item.pagePath, text: item.text, badgeText: item.badgeText, showRedDot: item.showRedDot }));
    }))));
  }
...
class TaroPickerGroup {
  ...
  render() {
    ...
    const pickerItem = range.map(item => {
      ...
      return (hAsync("div", { class: 'weui-picker__item' }, content));
    });
    return (hAsync(Host, { class: 'weui-picker__group' }, hAsync("div", { class: 'weui-picker__mask' }), hAsync("div", { class: 'weui-picker__indicator' }), hAsync("div", { class: 'weui-picker__content', style: this.getPosition() }, pickerItem)));
  }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-picker-group",
    "$members$": {
      "mode": [1],
      "range": [16],
      "rangeKey": [1, "range-key"],
...
class Text {
  ...
  render() {
    ...
    return (hAsync(Host, { style: style }, hAsync("slot", null)));
  }
...
const indexCss$3 = "taro-textarea-core{width:300px;display:block}taro-textarea-core .auto-height{height:auto}.taro-textarea{width:100%;height:inherit;appearance:none;cursor:auto;border:0;line-height:1.5;display:block;position:relative}.taro-textarea:focus{outline:none}";
...
class Textarea {
  ...
  render() {
    ...
    return (hAsync("textarea", Object.assign({ ref: input => {
        if (input) {
...
class Video {
  ...
  render() {
    ...
    return (hAsync(Host, { class: classnames('taro-video-container', {
        'taro-video-type-fullscreen': isFullScreen
      }), onTouchStart: this.onTouchStartContainer, onClick: this.onClickContainer }, hAsync("video", Object.assign({ class: 'taro-video-video', style: {
        'object-fit': objectFit
      }, ref: dom => {
        if (dom) {
          this.videoRef = dom;
        }
      }, autoplay: autoplay, loop: loop, muted: muted, poster: controls ? poster : undefined, playsinline: true, "webkit-playsinline": true, onPlay: this.handlePlay, onPause: this.handlePause, onEnded: this.handleEnded, onTimeUpdate: this.handleTimeUpdate, onError: this.handleError, onDurationChange: this.handleDurationChange, onProgress: this.handleProgress, onLoadedMetaData: this.handleLoadedMetaData }, nativeProps), "\u6682\u65F6\u4E0D\u652F\u6301\u64AD\u653E\u8BE5\u89C6\u9891"), hAsync("taro-video-danmu", { ref: dom => {
        if (dom) {
          this.danmuRef = dom;
        }
      }, enable: _enableDanmu }), isFirst && showCenterPlayBtn && !isPlaying && (hAsync("div", { class: 'taro-video-cover' }, hAsync("div", { class: 'taro-video-cover-play-button', onClick: () => this.play() }), hAsync("p", { class: 'taro-video-cover-duration' }, durationTime))), hAsync("taro-video-control", { ref: dom => {
        if (dom) {
          this.controlsRef = dom;
        }
      }, controls: controls, currentTime: this.currentTime, duration: duration, isPlaying: this.isPlaying, pauseFunc: this._pause, playFunc: this._play, seekFunc: this._seek, showPlayBtn: this.showPlayBtn, showProgress: this.showProgress }, showMuteBtn && (hAsync("div", { class: classnames('taro-video-mute', {
        'taro-video-type-mute': isMute
      }), onClick: this.toggleMute })), danmuBtn && (hAsync("div", { class: classnames('taro-video-danmu-button', {
        'taro-video-danmu-button-active': _enableDanmu
      }), onClick: this.toggleDanmu }, "\u5F39\u5E55")), showFullscreenBtn && (hAsync("div", { class: classnames('taro-video-fullscreen', {
        'taro-video-type-fullscreen': isFullScreen
      }), onClick: this.onClickFullScreenBtn }))), hAsync("div", { class: 'taro-video-toast taro-video-toast-volume', ref: dom => {
        if (dom) {
          this.toastVolumeRef = dom;
        }
      } }, hAsync("div", { class: 'taro-video-toast-title' }, "\u97F3\u91CF"), hAsync("div", { class: 'taro-video-toast-icon' }), hAsync("div", { class: 'taro-video-toast-value' }, hAsync("div", { class: 'taro-video-toast-value-content', ref: dom => {
        if (dom) {
          this.toastVolumeBarRef = dom;
        }
      } }, hAsync("div", { class: 'taro-video-toast-volume-grids' }, Array(10).fill(1).map(() => (hAsync("div", { class: 'taro-video-toast-volume-grids-item' }))))))), hAsync("div", { class: 'taro-video-toast taro-video-toast-progress', ref: dom => {
        if (dom) {
          this.toastProgressRef = dom;
        }
      } }, hAsync("div", { class: 'taro-video-toast-title', ref: dom => {
        if (dom) {
  ...
  static get cmpMeta() { return {
    ...
    "$listeners$": [[5, "touchmove", "onDocumentTouchMove"], [5, "touchend", "onDocumentTouchEnd"], [5, "touchcancel", "onDocumentTouchEnd"]],
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
  }; }
}
...
class VideoControl {
  ...
  render() {
    ...
    if (!showPlayBtn) {
      ...
      playBtn = hAsync("div", { class: 'taro-video-control-button taro-video-control-button-pause', onClick: pauseFunc });
    }
    else {
...
class VideoDanmu {
  ...
  render() {
    if (!this.enable)
      return '';
    return (hAsync(Host, { class: 'taro-video-danmu' }, this.danmuList.map(({ text, color, bottom, key }) => (hAsync("p", { class: 'taro-video-danmu-item', key: key, style: {
        color,
        bottom
      }, ref: ref => {
        if (ref) {
...
const indexCss$1 = "taro-view-core{display:block}";
