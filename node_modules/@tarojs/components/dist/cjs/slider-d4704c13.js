...
const index = require('./index-2f9fa58c.js');
...
const Slider = class {
  constructor(hostRef) {
    ...
    this.onChanging = index.createEvent(this, "changing", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, { class: 'weui-slider-box' }, index.h("div", { class: 'weui-slider' }, index.h("div", { class: 'weui-slider__inner', style: innerStyles, ref: c => (this.sliderInsRef = c) }, index.h("div", { style: trackStyles, class: 'weui-slider__track' }), index.h("div", { class: 'weui-slider__handler', ref: dom => {
        if (dom)
          this.handler = dom;
      }, style: handlerStyles }), index.h("input", { type: 'hidden', name: name, value: value }))), showValue && index.h("div", { class: 'weui-slider-box__value' }, value)));
  }
