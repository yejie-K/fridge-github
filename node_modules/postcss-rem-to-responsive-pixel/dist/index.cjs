"use strict";Object.defineProperty(exports, "__esModule", {value: true});// src/regex.ts
var remRegex = /"[^"]+"|'[^']+'|url\([^)]+\)|var\([^)]+\)|(\d+(?:\.\d+)?|\.\d+)rem/g;
...
var defu2 = createDefu((obj, key, value) => {
