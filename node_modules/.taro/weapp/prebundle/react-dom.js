import { FormElement, convertNumber2PX, init_dist as init_dist2, taroDocumentProvider } from "./chunk-SWEUG3IB.js";
import { PLATFORM_TYPE, capitalize, ensure, hooks, init_dist, internalComponents, isBoolean, isFunction, isNumber, isObject, isString, isUndefined, noop, toCamelCase } from "./chunk-GO7TBK4A.js";
import { require_react } from "./chunk-XDFXK7K5.js";
import { __commonJS, __toESM } from "./chunk-QRPWKJ4C.js";
...
function setStyle(style, key, value) {
    ...
    style[key] = isNumber(value) && IS_NON_DIMENSIONAL.test(key) === false ? "mini" === PLATFORM_TYPE.HARMONY ? value + "px" : convertNumber2PX(value) : value === null ? "" : value;
}
...
export { createPortal, createRoot, react_dom_default as default, findDOMNode, flushSync, internalInstanceKey, render, unmountComponentAtNode, unstable_batchedUpdates }; /*! Bundled license information:
