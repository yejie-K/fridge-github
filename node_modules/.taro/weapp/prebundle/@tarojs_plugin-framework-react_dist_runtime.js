import { CONTAINER, CONTEXT_ACTIONS, Current, ON_HIDE, ON_READY, ON_SHOW, PAGE_INIT, _raf, addLeadingSlash, eventCenter, eventHandler, getOnHideEventKey, getOnReadyEventKey, getOnShowEventKey, getPageInstance, getPath, incrementId, init_dist as init_dist2, injectPageInstance, perf, removePageInstance, safeExecute, taroDocumentProvider, taroWindowProvider } from "./chunk-SWEUG3IB.js";
import { EMPTY_OBJ, ensure, hooks, init_dist, isArray, isFunction, isUndefined } from "./chunk-GO7TBK4A.js";
...
function setReconciler(ReactDOM2) {
    ...
    if (false) {
        ...
        hooks.tap("getDOMNode", (inst)=>{
            if (!inst) {
                return taroDocumentProvider;
            } else if (inst instanceof HTMLElement) {
                return inst;
            } else if (inst.$taroPath) {
                const el = taroDocumentProvider.getElementById(inst.$taroPath);
                return el !== null && el !== void 0 ? el : taroDocumentProvider;
            }
        });
    }
}
...
function initNativeComponentEntry(params) {
    ...
    let app = taroDocumentProvider.getElementById("app");
    if (!isDefaultEntryDom && !nativeComponentApp) {
        const nativeApp = taroDocumentProvider.createElement("nativeComponent");
...
function createNativePageConfig(Component, pageName, data, react, reactDOM, pageConfig) {
    ...
    const pageObj = {
        ...
        [ONLOAD] (options = {}, cb) {
            ...
            const mountCallback = ()=>{
                pageElement = taroDocumentProvider.getElementById($taroPath);
        ...
        if (Component[lifecycle] || ((_a = Component.prototype) === null || _a === void 0 ? void 0 : _a[lifecycle]) || Component[lifecycle.replace(/^on/, "enable")]) {
            pageObj[lifecycle] = function(...args) {
                ...
                if (target === null || target === void 0 ? void 0 : target.id) {
                    const id2 = target.id;
                    const element = taroDocumentProvider.getElementById(id2);
                    if (element) {
...
function createNativeComponentConfig(Component, react, reactDOM, componentConfig) {
        ...
        properties: {
            props: {
                ...
                observer (_newVal, oldVal) {
                    var _a2, _b2, _c, _d;
                    if (false) {
                        const inst = taroDocumentProvider.getElementById(this.id);
        ...
        attached () {
            ...
            app.mount(Component, compId, ()=>this, ()=>{
                ...
                if (instance && instance.node) {
                    const el = taroDocumentProvider.getElementById(instance.node.uid);
                    if (el) {
                        el.ctx = this;
                    }
                }
    ...
    if (Component.onShareAppMessage || ((_a = Component.prototype) === null || _a === void 0 ? void 0 : _a.onShareAppMessage) || Component.enableShareAppMessage) {
        componentObj.methods.onShareAppMessage = function(options) {
            ...
            if (target) {
                const id = target.id;
                const element = taroDocumentProvider.getElementById(id);
                if (element) {
                    target.dataset = element.dataset;
                }
            }
